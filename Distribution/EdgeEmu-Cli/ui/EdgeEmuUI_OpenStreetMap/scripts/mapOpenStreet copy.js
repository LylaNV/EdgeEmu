...
function loadMapScript() {
 ...
 scriptContextMenu.src = '../dist/leaflet.contextmenu.js';
 document.body.appendChild(scriptContextMenu);
  ...
  scriptOpenRouteService.src = '../dist/L.Routing.OpenRouteServiceV2.js';
...
* LYLA: The fuction is called by 'confirmConfiguration' function
* */
...
function setUrlPath() {
  ...
  if (fullUrl.indexOf('index_OpenStreetMap.html') !== -1) {
    pageUrl = fullUrl.replace('index_OpenStreetMap.html', '');
    ...
    pageUrl = fullUrl.replace('Termite2UI_OpenStreetMap/WebPage/', '');
    setMarkerIconsUrls(pageUrl);
...
/*
* This function set the markers' icon.
* */
...
/*
* This function set the OpenRouteService API key which is needed for routing.
