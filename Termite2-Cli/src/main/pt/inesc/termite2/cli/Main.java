...
import src.main.pt.inesc.termite2.cli.commands.*;
import src.main.pt.inesc.termite2.cli.exceptions.ConfigErrorException;
import src.main.pt.inesc.termite2.cli.exceptions.RemoteAVDControllerException;
...
public class Main {
    ...
    //LYLA
    private static void startOpenStreetMapUi(Context context) throws IOException{
        try {
            OpenStreetMapUi openStreetMapUi = new OpenStreetMapUi(context);
            printOpenStreetMapUiStart();
            openStreetMapUi.start();
        } catch (WebPageErrorException e){
            e.printStackTrace();
            System.out.println("Starting console ui instead...");
            startConsoleUi(context);
    ...
    private static void askMode(){
        ...
        //LYLA
        System.out.println("  Type '3' to use the Webpage UI with OpenStreetMap.");
        System.out.println("");
    }
